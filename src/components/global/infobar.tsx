    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 ml-auto">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="rounded-full w-8 h-8 bg-primary flex items-center justify-center text-white hover:bg-primary/80">
                <Bell size={17} />
              </div>
            </SheetTrigger>
            <SheetContent className="mt-4 mr-4 pr-4 flex flex-col">
              ...
              {allNotifications?.length === 0 && (
                <div className="h-full flex items-center justify-center mb-4 text-muted-foreground">
