  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter className="max-md:flex max-md:flex-row max-md:items-center max-md:justify-end max-md:gap-2">
          <AlertDialogCancel className="max-md:mb-2">Cancel</AlertDialogCancel>
          <AlertDialogAction
            disabled={loading}
