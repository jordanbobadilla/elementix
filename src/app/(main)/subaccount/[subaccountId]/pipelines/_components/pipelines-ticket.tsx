              ...
              <DropdownMenu>
                  ...
                  <CardHeader className="p-[12px]">
                    ...
                    <HoverCard>
                      <HoverCardTrigger asChild>
                        <div
                          className="p-2 text-muted-foreground flex gap-2 hover:bg-muted 
                        transition-all rounded-lg cursor-pointer items-center"
                        >
                          <LinkIcon />
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        {ticket.assignedUserId && (
                          <span
                            className="text-xs w-28 overflow-ellipsis overflow-hidden 
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter className="flex items-center">
                    ...
                    <AlertDialogAction className="bg-destructive" onClick={handleDeleteTicket}>Delete</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </DropdownMenu>
            </AlertDialog>
