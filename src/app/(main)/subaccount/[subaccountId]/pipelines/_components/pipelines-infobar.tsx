...
const PipelinesInfobar = ({ subAccountId, pipelines, pipelineId }: Props) => {
  ...
  const handleClickCreatePipeline = () => {
    setOpenModal(
      <CustomModal
        ...
        subheading="Pipelinese allows you to group tickets 
        into lanes and track your business processes all in one place"
      >
...
export default PipelinesInfobar;
