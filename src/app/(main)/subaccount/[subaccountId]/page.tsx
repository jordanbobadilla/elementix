...
const SubAccountIdPage = async ({
  ...
  if (subaccountDetails.connectedAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: subaccountDetails.connectedAccountId,
    })
    ...
    potencialIncome = +totalPendingSessions
      .reduce((total, session) => total + (session.amount_total || 0), 0)
      .toFixed(2)
      ...
      <div className="relative h-full">
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex flex-col gap-4 xl:!flex-row">
            ...
            <Card className="flex-1 relative">
              <CardHeader>
                <CardDescription>Potencial Income</CardDescription>
                <CardTitle className="text-4xl">
                  {potencialIncome
                    ? `${currency} ${potencialIncome.toFixed(2)}`
                    : "$0.00"}
                </CardTitle>
                <small className="text-xs text-muted-foreground">
                  For the year {currentYear}
            ...
            <Card className="flex-1 relative">
              <CardHeader>
                <CardTitle className="text-4xl">Subaccount Goal</CardTitle>
                <CardDescription>
              ...
              <CardFooter>
                <div className="flex flex-col w-full">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-muted-foreground text-sm">
                      Current: {subaccountDetails.goal}
                    </span>
                  </div>
                  <Progress
                    value={(subaccounts.length / subaccountDetails.goal) * 100}
                  />
                </div>
              </CardFooter>
          ...
          <div className="flex gap-4 xl:!flex-row flex-col">
            ...
            <Card className="flex-1 xl:w-400px w-full">
              <CardHeader>
