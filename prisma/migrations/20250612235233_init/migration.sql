...
-- CreateEnum
CREATE TYPE "Plan" AS ENUM ('price_1RW9qBIf3DKNWBXwrgkdcadZ', 'price_1RW9qBIf3DKNWBXwu8IMNtqx');
...
-- CreateIndex
CREATE UNIQUE INDEX "AddOn_priceId_key" ON "AddOn"("priceId");

-- CreateIndex
CREATE INDEX "AddOn_agencyId_idx" ON "AddOn"("agencyId");
